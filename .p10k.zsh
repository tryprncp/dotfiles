# Generated by Powerlevel10k configuration wizard on 2024-04-20 at 16:32 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%242F╰─ʕっ•ᴥ•ʔっ' # for the root ʕっ-ᴥ•ʔ︻デ══━一# Connect right prompt lines with these symbols.
